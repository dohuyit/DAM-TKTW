                  ...
                  <table>
                    ...
                    <tbody id="user-table-body">
                      <?php foreach ($data_views as $view) : ?>
                        <tr>
                          <td>
                            <p><?= $view['name_account'] ?></p>
                          </td>
                          <td>
                            <p><?= $view['content_comments'] ?></p>
                          </td>
                          <td>
                            <p><?= $view['day_comments'] ?></p>
                          </td>
                          <td class="button-close">
                            <a href="index.php?action=delete-comment&id_delete=<?= $view['id_comments'] ?>">
