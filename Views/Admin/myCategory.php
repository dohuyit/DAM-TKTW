                        ...
                        <tr>
                          ...
                          <td>
                            <p>
                              ...
                              <a href="index.php?action=delete-cate&id=<?= $dataCate['id_cate'] ?>"><button onclick="return confirm('Bạn có muốn xóa không?')"><i class="fa-solid fa-trash"></i></button></a>
                            </p>
                          </td>
                        </tr>
                      <?php endforeach; ?>
