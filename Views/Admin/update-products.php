              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="item-form">
                  ...
                  <div class="option-sale">
                    <input value="0" name="flash_sale" id="default" type="radio" <?= ($products['flash_sale'] == 0) ? 'checked' : '' ?> />
                    <label for="default">Mặc Định</label>
                    <input value="1" name="flash_sale" id="sale" type="radio" <?= ($products['flash_sale'] == 1) ? 'checked' : '' ?> />
