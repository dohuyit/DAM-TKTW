                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><p><?=$data['name']?></p></td>
                          <td><p><?=$data['name_cate']?></p></td>
                          <td><p><?=$data['original_price'] . ".000đ"?></p></td>
                          <td><p><?=$data['discount_number'] . "%"?></p></td>
                          <td>
                           ...
                           <td>
                            <p>
                              ...
                              <a href="index.php?action=delete-products&id=<?=$data['id']?>"><i class="fa-solid fa-trash"></i></a>
                            </p>
                           </td>
                        </tr>
                        <?php endforeach;?>
