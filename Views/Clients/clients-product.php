          ...
          <div class="main-products-detailed">
            ...
            <div class="infor-products">
              ...
              <div class="phone-products">
                <p>
                  <span>Gọi</span><i class="fa-solid fa-phone-volume"></i><span>1800 100500(Free)</span><span>để nhận được ưu đãi độc quyền</span>
                </p>
              </div>
              ...
              <div class="desc-note">
                <p class="item">
                  <span>Giá sản phẩm thay đổi tuỳ trọng lượng vàng và đá</span>
                </p>
                <p class="item">
                  <span>Đổi sản phẩm trong 48h tại hệ thống cửa hàng PNJ
                  </span>
                </p>
                <p class="item">
                  <span></span>
          ...
          <div class="list-desc">
            ...
            <div class="tab-item">
              ...
              <div class="content-tab">
                <p id="formatted-text"><?= $productById['desc'] ?> </p>
              </div>
            </div>
                  ...
                  <?php foreach ($comments as $comment) : ?>
                    <div class="comment">
                      <div class="title-comment">
                        <p>
                          <?= htmlspecialchars($comment['name_account']) ?>
                        </p>
                        <span>
                          <?php for ($i = 0; $i < 5; $i++) : ?>
                        ...
                        <span><?= htmlspecialchars($comment['day_comments']) ?></span>
                      </div>
                      <p class="text-comments"><?= htmlspecialchars($comment['content_comments']) ?></p>
                    </div>
                  <?php endforeach; ?>
                <?php endif; ?>
                ...
                <?php foreach ($similarProducts as $similar) : ?>
                  <div class="item-products">
                    ...
                    <h3 class="title-products">
                      <a href="index.php?action=productContent&product_id=<?= $similar['id'] ?>"><?= $similar['name'] ?></a>
                    </h3>
