    ...
    <main>
      <section>
        <div class="main-heading">
          <div class="container">
            <div>
              <h1><span>Trang chủ</span>/<span>Tất cả trang sức</span></h1>
            </div>
          </div>
        ...
        <div class="main-body">
          <div class="container">
            ...
            <?php if (isset($_POST['keyword'])): ?>
              <h3 class="title-by-search" id="title-by-search">Sản Phẩm theo từ khóa tìm kiếm là: <strong><?= $_POST['keyword'] ?></strong></h3>
                  ...
                  <?php foreach ($productsBySearch as $searchValue) : ?>
                    <div class="item-products">
                      ...
                      <h3 class="title-products">
                        <a href="index.php?action=productContent&product_id=<?= $searchValue['id'] ?>"><?= $searchValue['name'] ?></a>
                      </h3>
              ...
              <div class="list-content-products">
                <?php foreach ($productsAll as $allValue) : ?>
                  <div class="item-products">
                    ...
                    <h3 class="title-products">
                      <a href="index.php?action=productContent&product_id=<?= $allValue['id'] ?>"><?= $allValue['name'] ?></a>
                    </h3>
